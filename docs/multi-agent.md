...
- **Older OpenClaw runtimes:** OpenClaw 2026.5.x+ is required. Older runtimes don't surface `ProviderCreateStreamFnContext.workspaceDir`, and the plugin throws at registration with a clear error pointing at the upgrade.
